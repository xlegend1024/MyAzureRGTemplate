...
Param(
  ...
  [string] $ResourceGroupName = 'FTPtest',
  [switch] $UploadArtifacts,
  [string] $StorageAccountName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\WinFTPStandalonevNetTemplate.json',
  [string] $TemplateParametersFile = '..\Templates\WinFTPStandalonevNetTemplate.param.json',
